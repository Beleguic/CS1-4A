    ...
    private function generatedCards() : array
    {
        ...
        $cards = [
            ...
            "pdf" => [
                1 => [
                    "nb" => $nbQuotation,
                    "link" => $this->generateUrl("front_app_devis_index"),
                    "title" => "Quotations",
                ...
                2 => [
                    "nb" => $nbInvoice,
                    "link" => $this->generateUrl("front_app_facture_index"),
                    "title" => "Invoices",
                    "icon" => "<svg xmlns='http://www.w3.org/2000/svg' class='w-full h-full' viewBox='0 0 24 24'><path fill='currentColor' d='M13 9V3.5L18.5 9M6 2c-1.11 0-2 .89-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6z'/></svg>"
                ],
                3 => [
            ...
            "product" => [
                1 => [
                    "nb" => $nbProduct,
                    "link" => $this->generateUrl("front_app_product_index"),
                    "title" => "Products",
                ...
                2 => [
                    "nb" => $nbCategory,
                    "link" => $this->generateUrl("front_app_category_index"),
                    "title" => "Categories",
